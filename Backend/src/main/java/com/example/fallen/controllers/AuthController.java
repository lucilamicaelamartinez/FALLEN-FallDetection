...
import com.example.fallen.dtos.UserWithElderlyDTO; // ✅ nuevo DTO

/**
 * REST controller for authentication, registration
 * and user / emergency-contact endpoints.
 */
@RestController
@RequestMapping("/api")
@CrossOrigin(origins = "*")
public class AuthController {
    ...
    public ResponseEntity<?> getMe(@RequestHeader("Authorization") String auth) {
        ...
        return ResponseEntity.ok(new UserWithElderlyDTO(u)); // ✅ devolvemos DTO con elderlyPersons
    }
    ...
    public static class UserRegistrationRequest {
        ...
        public void   setElderlyPersonId(Long id){ this.elderlyPersonId = id; }
    ...
    public static class PushTokenRequest {
        ...
        public void   setExpoToken(String token)   { this.expoToken = token; }
    }
